  ...
  return (
    <div className="custom-container sm:px-6 lg:px-8 mb-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 text-center py-6 gap-y-6">
        <div>
          <div className="border-t-2 border-r-2 rounded-tr-2xl h-8"></div>
          <h3 className="text-3xl font-bold">8+</h3>
          <p className="text-gray-600">Years of Experience</p>
        </div>
        <div>
          <div className="border-t-2 border-r-2 border-l-2 rounded-tr-2xl rounded-tl-2xl h-8"></div>
        ...
        <div className="col-span-2 md:col-span-1">
          <div className="border-t-2 border-l-2 rounded-tl-2xl h-8"></div>
